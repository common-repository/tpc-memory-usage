...
== Licensing ==
TPC! Memory Usage may not be altered or redistributed without prior authorization.

== Changelog ==

= 1.0 =
* Added charts to checkpoint reports
* Added IP detection compatibility for load balancers and proxies
* Fixed bar graph alignment in WordPress 3.8
* Fixed closing tags for options on report pages

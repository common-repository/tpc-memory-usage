...
wp_register_script('tpcmem-excanvas', plugins_url('tpc-memory-usage/js/flot/excanvas.min.js'), array(), '0.8.2', false);
wp_register_script('tpcmem-flot', plugins_url('tpc-memory-usage/js/flot/jquery.flot.min.js'), array('jquery', 'jquery-ui-core', 'tpcmem-excanvas'), '0.8.2', false);
wp_register_script('tpcmem-flot-categories', plugins_url('tpc-memory-usage/js/flot/jquery.flot.categories.min.js'), array('tpcmem-flot'), '0.8.2', false);
wp_register_script('tpcmem-flot-selection', plugins_url('tpc-memory-usage/js/flot/jquery.flot.selection.min.js'), array('tpcmem-flot'), '0.8.2', false);
wp_register_script('tpcmem-flot-time', plugins_url('tpc-memory-usage/js/flot/jquery.flot.time.min.js'), array('tpcmem-flot'), '0.8.2', false);
wp_register_script('tpcmem-reports', plugins_url('tpc-memory-usage/js/reports.js'), array('tpcmem-tablesorter', 'tpcmem-flot-categories', 'tpcmem-flot-selection', 'tpcmem-flot-time'), TPCMEM_VERSION, true);

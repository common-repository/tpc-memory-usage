...
// Detect IP address behind load balancers/proxies
...
<div id="tpcmem-overview-tabs" class="hidden">
    ...
    <div id="tpcmem-server">
        ...
        <tbody>
            ...
            <tr><th><?php esc_html_e('Client IP:'); ?></th><td><?php echo esc_html($clientIpAddress); ?></td></tr>
            <tr><th><?php esc_html_e('Client Hostname:'); ?></th><td><?php echo esc_html(gethostbyaddr($clientIpAddress)); ?></td></tr>
